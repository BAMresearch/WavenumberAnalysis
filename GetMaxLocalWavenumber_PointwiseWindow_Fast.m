function [local_k, k_window] = GetMaxLocalWavenumber_PointwiseWindow_Fast(Img, dx, N_BIN, N_FFT)
% GetMaxLocalWavenumber_PointwiseWindow_Fast
...
%     along with this program.  If not, see <https://www.gnu.org/licenses/>.
    ...
    elseif( ismatrix(Img) )
        ...
        for i_col = 1:N_COL     % loop over columns
            ...
            Imghat = fft(Img(:,idx_col), N_FFT, 2);
            for i_row = 1:N_ROW % loop over rows
                ...
                Amp_win = abs( fft( Imghat(idx_row,:), N_FFT, 1) );
%                 Amp_win_ref = abs( fft2( Img(idx_row,idx_col), N_FFT, N_FFT) );
